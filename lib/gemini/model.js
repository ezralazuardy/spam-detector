...
export const model = configuration.getGenerativeModel({
  model: "gemini-pro", // gemini-pro or gemini-1.5-pro-latest
});
...
export async function generateRandomSpamMessage(language = "English") {
  ...
  let prompt = `
    Help me generate a message for analyzer testing purposes.
    ...
    Don't use more than ${maxSentences} words!
    ...
    MAKE SURE THAT THE MESSAGE IS SAFE ENOUGH TO BE DISPLAYED!!!
  `;
